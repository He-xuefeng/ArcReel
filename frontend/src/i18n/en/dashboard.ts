...
export default {
  ...
  'active_label': 'In use',
  'default_preferred_label': 'Default',
  'credential_pool_settings': 'Credential pool settings',
  'credential_pool_enabled': 'Enable credential pool',
  'credential_pool_participation': 'Use in pool',
  'credential_pool_participation_for': 'Use {{name}} in pool',
  'credential_pool_concurrency_mode': 'Concurrency mode',
  'credential_pool_shared': 'Shared',
  'credential_pool_separate': 'Separate',
  'enabled_pool_credentials_count': 'Pool keys',
  'active_pool_leases_count': 'Active leases',
  'active_pool_leases': '{{count}} lease',
  'active_pool_leases_hint': 'Running work continues on its leased credential even if pooling is turned off.',
  'no_enabled_pool_credentials': 'No credential is currently enabled for pooling.',
  'waiting_for_credential': 'Waiting for an available credential',
  'credential_in_use': 'This credential still has running or resumable work and cannot be deleted.',
  'credential_binding_persist_failed': 'Could not save the provider job credential binding.',
  'credential_binding_missing': 'The provider job credential binding is missing; legacy active credential fallback is being used.',
  'credential_lease_conflict': 'Credential leasing conflicted with another worker. The task will wait and retry.',
  'credential_lease_release_failed': 'Credential lease release failed; recovery will retry later.',
