...
export default {
  ...
  'default_preferred_label': 'Mặc định',
  'credential_pool_settings': 'Cài đặt nhóm xác thực',
  'credential_pool_enabled': 'Bật nhóm xác thực',
  'credential_pool_participation': 'Tham gia nhóm',
  'credential_pool_participation_for': 'Cho {{name}} tham gia nhóm',
  'credential_pool_concurrency_mode': 'Chế độ đồng thời',
  'credential_pool_shared': 'Dùng chung',
  'credential_pool_separate': 'Tách riêng',
  'enabled_pool_credentials_count': 'Khóa trong nhóm',
  'active_pool_leases_count': 'Lease đang chạy',
  'active_pool_leases': '{{count}} lease',
  'active_pool_leases_hint': 'Tác vụ đang chạy tiếp tục dùng xác thực đã thuê, kể cả khi tắt nhóm.',
  'no_enabled_pool_credentials': 'Hiện không có xác thực nào bật cho nhóm.',
  'waiting_for_credential': 'Đang chờ xác thực khả dụng',
  'credential_in_use': 'Xác thực này vẫn có tác vụ đang chạy hoặc có thể khôi phục nên không thể xóa.',
  'credential_binding_persist_failed': 'Không thể lưu liên kết xác thực cho job của nhà cung cấp.',
  'credential_binding_missing': 'Thiếu liên kết xác thực cho job của nhà cung cấp; đang dùng đường tương thích active cũ.',
  'credential_lease_conflict': 'Lease xác thực xung đột với worker khác. Tác vụ sẽ chờ và thử lại.',
  'credential_lease_release_failed': 'Không thể giải phóng lease xác thực; cơ chế khôi phục sẽ thử lại sau.',
