...
export default {
  ...
  'active_label': '使用中',
  'default_preferred_label': '默认',
  'credential_pool_settings': '凭证池设置',
  'credential_pool_enabled': '启用凭证池化',
  'credential_pool_participation': '参与池化',
  'credential_pool_participation_for': '让 {{name}} 参与池化',
  'credential_pool_concurrency_mode': '并发模式',
  'credential_pool_shared': '共享',
  'credential_pool_separate': '分开',
  'enabled_pool_credentials_count': '池化凭证',
  'active_pool_leases_count': '活跃租约',
  'active_pool_leases': '{{count}} 个租约',
  'active_pool_leases_hint': '运行中的任务会继续使用已租用凭证，即使此后关闭池化。',
  'no_enabled_pool_credentials': '当前没有可用池化凭证。',
  'waiting_for_credential': '等待可用凭证',
  'credential_in_use': '凭证仍有关联运行中或可恢复任务，无法删除。',
  'credential_binding_persist_failed': '无法保存供应商任务的凭证绑定。',
  'credential_binding_missing': '供应商任务凭证绑定缺失，正在使用旧任务 active 凭证兼容路径。',
  'credential_lease_conflict': '凭证租约与其他 worker 发生竞争，任务会等待后重试。',
  'credential_lease_release_failed': '凭证租约释放失败，系统稍后会继续恢复。',
