MESSAGES = {
    ...
    "task_fail_waiting_for_credential": "Đang chờ thông tin xác thực khả dụng",
    "task_fail_credential_lease_conflict": "Xung đột khi thuê thông tin xác thực; tác vụ sẽ được đưa lại vào hàng đợi",
    "task_fail_credential_binding_persist_failed": "Không lưu được liên kết thông tin xác thực; tác vụ đã dừng để tránh tính phí trùng",
    "task_fail_credential_binding_missing": "Không tìm thấy liên kết thông tin xác thực của tác vụ; đang dùng đường dẫn tương thích cũ",
    "task_fail_credential_in_use": "Thông tin xác thực vẫn có tác vụ liên quan đang chạy nên không thể xóa",
    "task_fail_credential_lease_release_failed": "Không giải phóng được lượt thuê thông tin xác thực; hệ thống sẽ thử khôi phục sau",
