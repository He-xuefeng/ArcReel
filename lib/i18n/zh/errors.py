MESSAGES = {
    ...
    "task_fail_waiting_for_credential": "正在等待可用凭证",
    "task_fail_credential_lease_conflict": "凭证租赁发生并发冲突，任务将重新排队",
    "task_fail_credential_binding_persist_failed": "凭证绑定保存失败，任务已停止以避免重复计费",
    "task_fail_credential_binding_missing": "未找到任务的凭证绑定，已按历史兼容路径处理",
    "task_fail_credential_in_use": "凭证仍有关联运行中任务，无法删除",
    "task_fail_credential_lease_release_failed": "凭证租赁释放失败，系统稍后会尝试恢复",
