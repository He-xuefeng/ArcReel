MESSAGES = {
    ...
    "task_fail_waiting_for_credential": "Waiting for an available credential",
    "task_fail_credential_lease_conflict": "Credential lease conflict detected; the task will be requeued",
    "task_fail_credential_binding_persist_failed": "Failed to persist the credential binding; task stopped to avoid duplicate billing",
    "task_fail_credential_binding_missing": "Credential binding for this task was not found; using the legacy compatibility path",
    "task_fail_credential_in_use": "Credential still has related running tasks and cannot be deleted",
    "task_fail_credential_lease_release_failed": "Failed to release the credential lease; the system will attempt recovery later",
